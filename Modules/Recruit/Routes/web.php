...
Route::post('account/job-applications/send-copmose-email', [JobApplicationController::class, 'sendComposeEmail'])->name('job-application-send-compose-email');
Route::post('add/company-smtp-setting', [RecruitSettingController::class, 'addCompanySmtpSetting'])->name('add-company-smtp-setting');
Route::get('add/company-email-template', [RecruitSettingController::class, 'addCompanyEmailTemplate'])->name('add-company-email-template');
Route::post('save/company-email-template', [RecruitSettingController::class, 'saveCompanyEmailTemplate'])->name('save_company_email_template');
Route::post('/update-company-email-template/{id}', [RecruitSettingController::class, 'updateCompanyEmailTemplate'])->name('update_company_email_template');
Route::get('/edit-company-email-template/{id}', [RecruitSettingController::class, 'editCompanyEmailTemplate'])->name('edit_company_email_template');
Route::post('delete/company-email-template/{id}', [RecruitSettingController::class, 'deleteCompanyEmailTemplate'])->name('delete-company-email-template');
