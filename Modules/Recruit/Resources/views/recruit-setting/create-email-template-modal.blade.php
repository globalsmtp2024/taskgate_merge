<div class="modal fade" id="addCompanyEmailTemplateModal" tabindex="-1" role="dialog" aria-labelledby="composeModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="portlet-body">
                    <form id="company-email-template-form">
                ...
                <small class="form-text text-muted">Supported file types: .pdf, .doc, .docx, .txt</small>
                        ...
                        <button id="save-company-email-template" type="submit" class="btn btn-primary">Save</button>
                    </form>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#company-email-template-form').on('submit', function(e) {
            e.preventDefault();
            ...
            // Send AJAX request
            $.ajax({
                url: '{{ route('company_email_template_save') }}',
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
