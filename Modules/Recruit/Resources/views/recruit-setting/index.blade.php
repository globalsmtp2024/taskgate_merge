                        ...
                        <div class="nav" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link f-15 recruit-source-setting"
                             ...
                             <a class="nav-item nav-link f-15 recruit-smtp-setting"
                               href="{{ route('recruit-settings.index') }}?tab=recruit-email-setting"
                               role="tab"
                               aria-controls="nav-recruit-setting" aria-selected="true"
                               ajax="false">@lang('Email Settings')
                            </a>
                          
                            <a class="nav-item nav-link f-15 recruit-email-template-setting"
                               href="{{ route('recruit-settings.index') }}?tab=recruit-email-template-setting"
                               role="tab"
                               aria-controls="nav-recruit-setting" aria-selected="true"
                               ajax="false">@lang('Email Template Settings')
                            </a>
                        </div>
                    </nav>
                </div>
