            ...
            <div class="bg-additional-grey rounded my-3">
                ...
                <div class="s-b-inner s-b-notifications bg-white b-shadow-4 rounded">
                    ...
                    <x-tab-section class="task-tabs">
                        ...
                        <x-tab-item class="ajax-tab" :active="(request('view') === 'emails-thread')"
                                    :link="route('job-applications.show', $application->id).'?view=emails-thread'">
                            @lang('recruit::modules.jobApplication.emails')</x-tab-item>
...
<script>
    $(document).ready(function () {
        ...
        $("body").on("click", ".email-tab", function(event) {
            event.preventDefault();
                ...
                success: function(response) {
                    if (response.status == "success") {
                        ...
                        if(type == 'sent') {
                            ...
                            $('#inbox').removeClass('active').addClass('fade');
                            $('#sent').removeClass('fade').addClass('active');
                        } else{
                            $('#inbox_tab').addClass('active');
                            $('#sent').removeClass('active').addClass('fade');
                            $('#inbox').removeClass('fade').addClass('active');
                        }
                    }
                }
            });
