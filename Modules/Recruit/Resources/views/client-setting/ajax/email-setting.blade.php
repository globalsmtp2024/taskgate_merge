        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 ">
                <div class="form-group my-3 mr-0 mr-lg-2 mr-md-2 field">
                    ...
                    <input type="text" value="{{ isset($mail->companySmtpSetting->sender_name) ? $mail->companySmtpSetting->sender_name : '' }}" class="form-control height-35 f-14" placeholder="e.g. John Doe"
                        name="mail_from_name" id="mail_from_name" autocomplete="off">
                </div>
            </div>
            <div class="col-lg-6 col-md-6 ">
                <div class="form-group my-3 mr-0 mr-lg-2 mr-md-2 field">
                    ...
                    <input type="text" class="form-control height-35 f-14" value="{{ isset($mail->companySmtpSetting->sender_email) ? $mail->companySmtpSetting->sender_email : '' }}" placeholder="e.g. johndoe@example.com"
                         name="mail_from_email" id="mail_from_email" autocomplete="off">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 smtp_div">
                <div class="form-group my-3 mr-0 mr-lg-2 mr-md-2 field">
                    ...
                    <input type="text" class="form-control height-35 f-14" placeholder="" value="{{ isset($mail->companySmtpSetting->smtp_host) ? $mail->companySmtpSetting->smtp_host : '' }}" name="mail_host"
            ...
            <div class="col-lg-6 col-md-6 smtp_div">
                <div class="form-group my-3 mr-0 mr-lg-2 mr-md-2 field">
                    ...
                    <input type="text"
                        placeholder="{mail.REPLACE_WITH_YOUR_DOMAIN.com:993/imap/ssl/novalidate-cert}"
                        class="form-control height-35 f-14" placeholder="" value="{{ isset($mail->companySmtpSetting->imap_host) ? $mail->companySmtpSetting->imap_host : '' }}" name="imap_host" id="imap_host"
                        autocomplete="off">
            ...
            <div class="col-lg-2 col-md-2">
                <div class="form-group my-3 field">
                    ...
                    <input type="text" class="form-control height-35 f-14" placeholder="465"
                        name="mail_port" value="{{ isset($mail->companySmtpSetting->smtp_port) ? $mail->companySmtpSetting->smtp_port : '' }}" id="mail_port" autocomplete="off">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 smtp_div">
                <div class="form-group my-3 mr-0 mr-lg-2 mr-md-2 field">
                    ...
                    value="{{ isset($mail->companySmtpSetting->smtp_username) ? $mail->companySmtpSetting->smtp_username : '' }}" name="mail_username" id="mail_username" autocomplete="off">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 smtp_div">
                ...
                <div class="input-group">
                    ...
                    <input type="password" name="mail_password" id="mail_password" value="{{ isset($mail->companySmtpSetting->smtp_password) ? $mail->companySmtpSetting->smtp_password : '' }}"
        ...
        <div class="row" style="padding-top: 10px;">
            <div class="col-12">
                <div class="float-right">
                    <button type="button" class="btn-primary rounded f-14 p-2 mr-3" id="save-email-form">
...
<script>
    $(document).ready(function () {
        $('#save-email-form').on('click', function (e) {
            ...
            // Send AJAX request
            $.ajax({
                url: '{{ route("add-company-smtp-setting-client") }}',
                type: 'POST',
                data: formData,
