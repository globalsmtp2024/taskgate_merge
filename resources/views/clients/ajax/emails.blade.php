                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link email-tab active" id="inbox_tab" data-type="inbox"
                                href="{{ route('clients.show', $client->id) . '?tab=emails' }}">Inbox</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link email-tab" data-type="sent" id="sent_tab"
                                href="{{ route('clients.show', $client->id) . '?tab=emails&sent=true' }}">Sent</a>
                        </li>
                    </ul>
    ...
    $(document).ready(function() {
        ...
        $('#replyButton').on('click', function() {
            ...
            $('#reply-email-form').on('submit', function(e) {
                ...
                formData.append('to_email', '<?php echo $client->email; ?>');
                // const buttons = document.querySelectorAll("#reply-email-form button");
                const lastButton = document.querySelector(
                    "#reply-email-form button[type='submit']");
        ...
        $('#compose-email-form').on('submit', function(e) {
            ...
            formData.append('to-email', '<?php echo $client->email; ?>');
            formData.append('_token', '{{ csrf_token() }}');
