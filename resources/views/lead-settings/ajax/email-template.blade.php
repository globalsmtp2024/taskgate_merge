<div class="table-responsive p-20">
    <div id="table-actions" class="d-block d-lg-flex align-items-center">
        <x-forms.button-primary icon="plus" id="addTemplateLead" class="mb-2">
            @lang('app.addNew')
            @lang('Template')
            ...
            <div class="modal-body">
                <form id="compose-email-form">
                    ...
                    <div class="modal-footer">
                        ...
                        <x-forms.button-primary id="compose-email-button" type="submit" icon="check">@lang('app.save')</x-forms.button-primary>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="edit-email-form">
                    ...
                    <div class="modal-footer">
                        <x-forms.button-cancel data-dismiss="modal" class="border-0 mr-3">@lang('app.cancel')</x-forms.button-cancel>
                        <x-forms.button-primary id="edit-email-button" type="submit" icon="check">@lang('app.update')</x-forms.button-primary>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('body').on('click', '.edit-email-template', function() {
            ...
            $.ajax({
                url: "{{ route('company_lead_email_template_edit', ':id') }}".replace(":id", templateId),
                type: 'GET',
        ...
        $('#edit-email-button').on('click', function(e) {
            ...
            var content_data = escape(htmlContent);
            $('#edit-email-content-input').val(content_data);
            ...
            var url = "{{ route('company_lead_email_template_update', ':id') }}";
    ...
    $('body').off('click', "#addTemplateLead").on('click', '#addTemplateLead', function() {
